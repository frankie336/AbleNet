...
class FormalAutoShellInterface(metaclass=abc.ABCMeta):
    ...
    def l3vpn_shell(self, host_ip: str,service_name: str):
        """Make build_l3vpn4_changes on PE device"""
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def cios_decom_l3vpn(self):
        """Decomission Cisco IOS MPLS VPN"""
        raise NotImplementedError
    ...
    @abc.abstractmethod
    def build_l3vpn4_changes(self, service_name: str):
        """Brings together vpn4 L2/L3 build changes and implements sequentially"""
        raise NotImplementedError

    @abc.abstractmethod
    def decom_l3vpn4_changes(self, service_name: str):
        """Brings together vpn4 L2/L3 decom changes and implements sequentially"""
        raise NotImplementedError
...
class LoadDataToList(FormalAutoShellInterface):
    ...
    def cios_build_l3vpn(self,service_name: str):
        """Builds Cisco IOS MPLS VPN"""
    ...
    def cios_decom_l3vpn(self):
        ...
        REMOVE VRF
        """
        rem_vrf = 'no ip vrf '+service_provision_dict['service_name']
...
class ChannelClass(LoadDataToList):
    ...
    def l3vpn_shell(self, host_ip: str,service_name: str):
        ...
        command_set = self.cios_build_l3vpn(service_name=service_name)
